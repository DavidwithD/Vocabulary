(function () {
    ...
    const FR_IRREGULAR = new Map([
        ...
        ['doive', 'devoir'], ['doives', 'devoir'],
        ['dû', 'devoir'], ['due', 'devoir'], ['dues', 'devoir'],
        // dire
        ...
        ['prenne', 'prendre'], ['prennes', 'prendre'],
    ...
    const ES_IRREGULAR = new Map([
        ...
        ['sería', 'ser'], ['serías', 'ser'], ['seríamos', 'ser'],
        ['seríais', 'ser'], ['serían', 'ser'],
        ['sea', 'ser'], ['seas', 'ser'], ['seamos', 'ser'],
        ['seáis', 'ser'], ['sean', 'ser'], ['sido', 'ser'],
        // estar
        ['estoy', 'estar'], ['estás', 'estar'], ['está', 'estar'],
        ['estamos', 'estar'], ['estáis', 'estar'], ['están', 'estar'],
        ['estaba', 'estar'], ['estabas', 'estar'], ['estábamos', 'estar'],
        ['estabais', 'estar'], ['estaban', 'estar'],
        ['estuve', 'estar'], ['estuviste', 'estar'], ['estuvo', 'estar'],
        ['estuvimos', 'estar'], ['estuvisteis', 'estar'], ['estuvieron', 'estar'],
        ['estaré', 'estar'], ['estarás', 'estar'], ['estará', 'estar'],
        ['estaremos', 'estar'], ['estaréis', 'estar'], ['estarán', 'estar'],
        ['estaría', 'estar'], ['estarías', 'estar'], ['estaríamos', 'estar'],
        ['estarían', 'estar'],
        ['esté', 'estar'], ['estés', 'estar'], ['estemos', 'estar'],
        ['estén', 'estar'], ['estado', 'estar'],
        // haber
        ['he', 'haber'], ['has', 'haber'], ['ha', 'haber'], ['hay', 'haber'],
        ['hemos', 'haber'], ['habéis', 'haber'], ['han', 'haber'],
        ['había', 'haber'], ['habías', 'haber'], ['habíamos', 'haber'],
        ['habían', 'haber'],
        ['hube', 'haber'], ['hubiste', 'haber'], ['hubo', 'haber'],
        ['hubimos', 'haber'], ['hubieron', 'haber'],
        ['habré', 'haber'], ['habrás', 'haber'], ['habrá', 'haber'],
        ['habremos', 'haber'], ['habrán', 'haber'],
        ['habría', 'haber'], ['habrías', 'haber'], ['habríamos', 'haber'],
        ['habrían', 'haber'],
        ['haya', 'haber'], ['hayas', 'haber'], ['hayamos', 'haber'],
        ['hayan', 'haber'], ['habido', 'haber'],
        // tener
        ['tengo', 'tener'], ['tienes', 'tener'], ['tiene', 'tener'],
        ['tenemos', 'tener'], ['tenéis', 'tener'], ['tienen', 'tener'],
        ['tenía', 'tener'], ['tenías', 'tener'], ['teníamos', 'tener'],
        ['tenían', 'tener'],
        ['tuve', 'tener'], ['tuviste', 'tener'], ['tuvo', 'tener'],
        ['tuvimos', 'tener'], ['tuvieron', 'tener'],
        ['tendré', 'tener'], ['tendrás', 'tener'], ['tendrá', 'tener'],
        ['tendremos', 'tener'], ['tendrán', 'tener'],
        ['tendría', 'tener'], ['tendrías', 'tener'], ['tendríamos', 'tener'],
        ['tendrían', 'tener'],
        ['tenga', 'tener'], ['tengas', 'tener'], ['tengamos', 'tener'],
        ['tengan', 'tener'], ['tenido', 'tener'],
        // ir
        ['voy', 'ir'], ['vas', 'ir'], ['va', 'ir'],
        ...
        ['iría', 'ir'], ['irías', 'ir'], ['iríamos', 'ir'],
        ['irían', 'ir'],
        ['vaya', 'ir'], ['vayas', 'ir'], ['vayamos', 'ir'],
        ['vayan', 'ir'], ['ido', 'ir'], ['yendo', 'ir'],
        // hacer
        ['hago', 'hacer'], ['haces', 'hacer'], ['hace', 'hacer'],
        ['hacemos', 'hacer'], ['hacéis', 'hacer'], ['hacen', 'hacer'],
        ['hacía', 'hacer'], ['hacías', 'hacer'], ['hacíamos', 'hacer'],
        ['hacían', 'hacer'],
        ['hice', 'hacer'], ['hiciste', 'hacer'], ['hizo', 'hacer'],
        ['hicimos', 'hacer'], ['hicieron', 'hacer'],
        ['haré', 'hacer'], ['harás', 'hacer'], ['hará', 'hacer'],
        ['haremos', 'hacer'], ['harán', 'hacer'],
        ['haría', 'hacer'], ['harías', 'hacer'], ['haríamos', 'hacer'],
        ['harían', 'hacer'],
        ['haga', 'hacer'], ['hagas', 'hacer'], ['hagamos', 'hacer'],
        ['hagan', 'hacer'], ['hecho', 'hacer'], ['haciendo', 'hacer'],
        // poder
        ['puedo', 'poder'], ['puedes', 'poder'], ['puede', 'poder'],
        ['podemos', 'poder'], ['podéis', 'poder'], ['pueden', 'poder'],
        ['podía', 'poder'], ['podías', 'poder'], ['podíamos', 'poder'],
        ['podían', 'poder'],
        ['pude', 'poder'], ['pudiste', 'poder'], ['pudo', 'poder'],
        ['pudimos', 'poder'], ['pudieron', 'poder'],
        ['podré', 'poder'], ['podrás', 'poder'], ['podrá', 'poder'],
        ['podremos', 'poder'], ['podrán', 'poder'],
        ['podría', 'poder'], ['podrías', 'poder'], ['podríamos', 'poder'],
        ['podrían', 'poder'],
        ['pueda', 'poder'], ['puedas', 'poder'], ['podamos', 'poder'],
        ['puedan', 'poder'], ['podido', 'poder'], ['pudiendo', 'poder'],
        // querer
        ['quiero', 'querer'], ['quieres', 'querer'], ['quiere', 'querer'],
        ['queremos', 'querer'], ['queréis', 'querer'], ['quieren', 'querer'],
        ['quería', 'querer'], ['querías', 'querer'], ['queríamos', 'querer'],
        ['querían', 'querer'],
        ['quise', 'querer'], ['quisiste', 'querer'], ['quiso', 'querer'],
        ['quisimos', 'querer'], ['quisieron', 'querer'],
        ['querré', 'querer'], ['querrás', 'querer'], ['querrá', 'querer'],
        ['querremos', 'querer'], ['querrán', 'querer'],
        ['querría', 'querer'], ['querrías', 'querer'], ['querríamos', 'querer'],
        ['querrían', 'querer'],
        ['quiera', 'querer'], ['quieras', 'querer'], ['queramos', 'querer'],
        ['quieran', 'querer'], ['querido', 'querer'],
        // decir
        ['digo', 'decir'], ['dices', 'decir'], ['dice', 'decir'],
        ['decimos', 'decir'], ['decís', 'decir'], ['dicen', 'decir'],
        ['decía', 'decir'], ['decías', 'decir'], ['decíamos', 'decir'],
        ['decían', 'decir'],
        ['dije', 'decir'], ['dijiste', 'decir'], ['dijo', 'decir'],
        ['dijimos', 'decir'], ['dijeron', 'decir'],
        ['diré', 'decir'], ['dirás', 'decir'], ['dirá', 'decir'],
        ['diremos', 'decir'], ['dirán', 'decir'],
        ['diría', 'decir'], ['dirías', 'decir'], ['diríamos', 'decir'],
        ['dirían', 'decir'],
        ['diga', 'decir'], ['digas', 'decir'], ['digamos', 'decir'],
        ['digan', 'decir'], ['dicho', 'decir'], ['diciendo', 'decir'],
        // saber
        ['sé', 'saber'], ['sabes', 'saber'], ['sabe', 'saber'],
        ['sabemos', 'saber'], ['sabéis', 'saber'], ['saben', 'saber'],
        ['sabía', 'saber'], ['sabías', 'saber'], ['sabíamos', 'saber'],
        ['sabían', 'saber'],
        ['supe', 'saber'], ['supiste', 'saber'], ['supo', 'saber'],
        ['supimos', 'saber'], ['supieron', 'saber'],
        ['sabré', 'saber'], ['sabrás', 'saber'], ['sabrá', 'saber'],
        ['sabremos', 'saber'], ['sabrán', 'saber'],
        ['sabría', 'saber'], ['sabrías', 'saber'], ['sabríamos', 'saber'],
        ['sabrían', 'saber'],
        ['sepa', 'saber'], ['sepas', 'saber'], ['sepamos', 'saber'],
        ['sepan', 'saber'], ['sabido', 'saber'],
        // venir
        ['vengo', 'venir'], ['vienes', 'venir'], ['viene', 'venir'],
        ['venimos', 'venir'], ['venís', 'venir'], ['vienen', 'venir'],
        ['venía', 'venir'], ['venías', 'venir'], ['veníamos', 'venir'],
        ['venían', 'venir'],
        ['vine', 'venir'], ['viniste', 'venir'], ['vino', 'venir'],
        ['vinimos', 'venir'], ['vinieron', 'venir'],
        ['vendré', 'venir'], ['vendrás', 'venir'], ['vendrá', 'venir'],
        ['vendremos', 'venir'], ['vendrán', 'venir'],
        ['vendría', 'venir'], ['vendrías', 'venir'], ['vendríamos', 'venir'],
        ['vendrían', 'venir'],
        ['venga', 'venir'], ['vengas', 'venir'], ['vengamos', 'venir'],
        ['vengan', 'venir'], ['venido', 'venir'], ['viniendo', 'venir'],
        // poner
        ['pongo', 'poner'], ['pones', 'poner'], ['pone', 'poner'],
        ['ponemos', 'poner'], ['ponéis', 'poner'], ['ponen', 'poner'],
        ['ponía', 'poner'], ['ponías', 'poner'], ['poníamos', 'poner'],
        ['ponían', 'poner'],
        ['puse', 'poner'], ['pusiste', 'poner'], ['puso', 'poner'],
        ['pusimos', 'poner'], ['pusieron', 'poner'],
        ['pondré', 'poner'], ['pondrás', 'poner'], ['pondrá', 'poner'],
        ['pondremos', 'poner'], ['pondrán', 'poner'],
        ['pondría', 'poner'], ['pondrías', 'poner'], ['pondríamos', 'poner'],
        ['pondrían', 'poner'],
        ['ponga', 'poner'], ['pongas', 'poner'], ['pongamos', 'poner'],
        ['pongan', 'poner'], ['puesto', 'poner'], ['poniendo', 'poner'],
        // salir
        ['salgo', 'salir'], ['sales', 'salir'], ['sale', 'salir'],
        ['salimos', 'salir'], ['salís', 'salir'], ['salen', 'salir'],
        ['salía', 'salir'], ['salías', 'salir'], ['salíamos', 'salir'],
        ['salían', 'salir'],
        ['salí', 'salir'], ['saliste', 'salir'], ['salió', 'salir'],
        ['salieron', 'salir'],
        ['saldré', 'salir'], ['saldrás', 'salir'], ['saldrá', 'salir'],
        ['saldremos', 'salir'], ['saldrán', 'salir'],
        ['saldría', 'salir'], ['saldrías', 'salir'], ['saldríamos', 'salir'],
        ['saldrían', 'salir'],
        ['salga', 'salir'], ['salgas', 'salir'], ['salgamos', 'salir'],
        ['salgan', 'salir'], ['salido', 'salir'],
        // dar
        ['doy', 'dar'], ['das', 'dar'], ['da', 'dar'],
        ['damos', 'dar'], ['dais', 'dar'], ['dan', 'dar'],
        ['daba', 'dar'], ['dabas', 'dar'], ['dábamos', 'dar'],
        ['daban', 'dar'],
        ['di', 'dar'], ['diste', 'dar'], ['dio', 'dar'],
        ['dimos', 'dar'], ['dieron', 'dar'],
        ['daré', 'dar'], ['darás', 'dar'], ['dará', 'dar'],
        ['daremos', 'dar'], ['darán', 'dar'],
        ['daría', 'dar'], ['darías', 'dar'], ['daríamos', 'dar'],
        ['darían', 'dar'],
        ['dé', 'dar'], ['des', 'dar'], ['demos', 'dar'],
        ['den', 'dar'], ['dado', 'dar'], ['dando', 'dar'],
        // ver
        ['veo', 'ver'], ['ves', 'ver'], ['ve', 'ver'],
        ['vemos', 'ver'], ['veis', 'ver'], ['ven', 'ver'],
        ['veía', 'ver'], ['veías', 'ver'], ['veíamos', 'ver'],
        ['veían', 'ver'],
        ['vi', 'ver'], ['viste', 'ver'], ['vio', 'ver'],
        ['vimos', 'ver'], ['vieron', 'ver'],
        ['veré', 'ver'], ['verás', 'ver'], ['verá', 'ver'],
        ['veremos', 'ver'], ['verán', 'ver'],
        ['vería', 'ver'], ['verías', 'ver'], ['veríamos', 'ver'],
        ['verían', 'ver'],
        ['vea', 'ver'], ['veas', 'ver'], ['veamos', 'ver'],
        ['vean', 'ver'], ['visto', 'ver'], ['viendo', 'ver'],
        // conocer
        ['conozco', 'conocer'],
        // conducir
        ['conduzco', 'conducir'], ['conduje', 'conducir'], ['condujo', 'conducir'],
        ['condujimos', 'conducir'], ['condujeron', 'conducir'],
        // traer
        ['traigo', 'traer'], ['traje', 'traer'], ['trajiste', 'traer'],
        ['trajo', 'traer'], ['trajimos', 'traer'], ['trajeron', 'traer'],
        ['traído', 'traer'], ['trayendo', 'traer'],
        // oír
        ['oigo', 'oír'], ['oyes', 'oír'], ['oye', 'oír'],
        ['oímos', 'oír'], ['oyen', 'oír'], ['oí', 'oír'],
        ['oyó', 'oír'], ['oyeron', 'oír'], ['oído', 'oír'], ['oyendo', 'oír'],
        // caer
        ['caigo', 'caer'], ['caí', 'caer'], ['cayó', 'caer'],
        ['cayeron', 'caer'], ['caído', 'caer'], ['cayendo', 'caer'],
    ]);
    /**
    ...
    function shouldSkipWord(word) {
        ...
        if (currentLanguage === 'en' && !/^[a-zA-Z]+$/.test(word))
            return true;
        if ((currentLanguage === 'fr' || currentLanguage === 'es') && !/^[a-zA-ZÀ-ÖØ-öø-ÿ]+$/.test(word))
            return true;
        return false;
    }
    /**
