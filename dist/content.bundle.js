(function () {
    ...
    const FAMILIAR_CLASS = 'vocab-builder-word'; // Familiar words (not visually highlighted)
    ...
    let COMMON_WORDS = new Set(); // Common words at or below the user's CEFR threshold, built from CEFR_WORDS data
    let familiarWordSet = new Set(); // Familiar words
    ...
    const pageUnfamiliarLemmas = new Map();
    const pageLearningLemmas = new Map();
    const pageFamiliarLemmas = new Map();
    const pageCommonLemmas = new Map();
    // Setters for mutable state (since we export lets)
    function setCurrentLanguage(lang) {
        currentLanguage = lang;
    }
    function setFamiliarWordSet(words) {
    ...
    */
     ...
     */
    function createTextNode(text, lemma = '') {
        const plainText = document.createTextNode(text);
        plainText.lemma = lemma;
        return plainText;
    }
    /**
     ...
     */
    function addToLemmaMap(map, lemma, node) {
     ...
     */
    function trackLemma(lemma, wordClass, node) {
        switch (wordClass) {
            case 'familiar':
                addToLemmaMap(pageFamiliarLemmas, lemma, node);
                break;
            case 'learning':
                addToLemmaMap(pageLearningLemmas, lemma, node);
                break;
            case 'unknown':
                addToLemmaMap(pageUnfamiliarLemmas, lemma, node);
                break;
            case 'common':
                addToLemmaMap(pageCommonLemmas, lemma, node);
                break;
        }
    }
    /**
     ...
     */
    function createNodeByLemma(text, lemma) {
     ...
     */
    function buildFragmentFromTerms(terms) {
     ...
     */
    function saveWord(lemma, status, targetSet) {
        targetSet.add(lemma);
     ...
     */
    function moveSpans(lemma, from, to, className, styles) {
    ...
    function addWordAsLearning(lemma) {
        ...
        moveSpans(lemma, pageUnfamiliarLemmas, pageLearningLemmas, LEARNING_CLASS, { bg: '#fff3e0', color: '#e65100', cursor: 'pointer' });
    }
    /**
    ...
    function promoteToFamiliar(lemma) {
        ...
        moveSpans(lemma, pageLearningLemmas, pageFamiliarLemmas, FAMILIAR_CLASS, { bg: '', color: '', cursor: '' });
    }
    /**
    ...
    function demoteToLearning(lemma) {
        ...
        saveWord(lemma, 'learning', learningWordSet);
        moveSpans(lemma, pageFamiliarLemmas, pageLearningLemmas, LEARNING_CLASS, { bg: '#fff3e0', color: '#e65100', cursor: 'pointer' });
    }
    /**
     ...
     */
    function addCommonWordAsLearning() {
